...
public class q05 {
    ...
    public static void pesquisaSequencial(Personagem[] listaDePersonagens){
        Scanner scan = new Scanner(System.in);
        String nome = scan.nextLine();
        while(checkEnd(nome)){
            boolean found = false;
            for(int i = 0; i< listaDePersonagens.length; i++){
                if(igual(listaDePersonagens[i].getName(),nome)){
